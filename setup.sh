...
echo -e "   See ${YELLOW}GITHUB_PAGES_INTEGRATION.md${NC} for instructions"
echo ""
echo -e "${BLUE}Documentation:${NC}"
echo -e "  - Full User Guide: ${YELLOW}README.md${NC}"
echo -e "  - Web Dashboard: ${YELLOW}GITHUB_PAGES.md${NC}"
echo -e "  - ML Training: ${YELLOW}FEEDBACK_LOOP.md${NC}"
echo -e "  - Deployment: ${YELLOW}AWS_DEPLOYMENT.md${NC}"
echo ""
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
